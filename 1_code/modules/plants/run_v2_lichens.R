# ---
# title: Run v2 Lichen Modelling Pipeline
# author: Brendan Casey
# created: 2026-09-05
# inputs:
#   scripts, in 0_data/v2_scripts/plants/:
#     - 02b_hierarchical-models-lichens.R
#     - 03b_model-validation-lichens.R
...
#     - 3_output/validation/lichen-models-validation.Rdata
#   in this repository:
...
#   - 03b validates with protocol.flag = TRUE, unlike 03c and
#     03d.
...
if (!exists("run_02b", inherits = FALSE)) {
  run_02b <- TRUE # 02b_hierarchical-models-lichens.R
}
if (!exists("run_03b", inherits = FALSE)) {
  run_03b <- TRUE # 03b_model-validation-lichens.R
}
...
if (run_03b) {
  # 03b reads the models written by 02b. When 02b runs in the same
...
if (run_02b) {
  run_step(
    label = "02b: Hierarchical models (lichens)",
    script = "02b_hierarchical-models-lichens.R",
...
if (run_03b) {
  run_step(
    label = "03b: Model validation (lichens)",
    script = "03b_model-validation-lichens.R",
    code_dir = v2_code_dir,
    run_dir = v2_root,
    log_dir = log_path,
    protect = runner_objects
