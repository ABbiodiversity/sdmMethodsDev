# ---
# title: Run v2 Vascular Plant Modelling Pipeline
# author: Brendan Casey
# created: 2026-09-05
# inputs:
#   scripts, in 0_data/v2_scripts/plants/:
#     - 02d_hierarchical-models-vascular-plants.R
#     - 03d_model-validation-vascular-plants.R
...
#     - 3_output/validation/vascular-plant-models-validation.Rdata
#   in this repository:
...
if (!exists("run_02d", inherits = FALSE)) {
  run_02d <- TRUE # 02d_hierarchical-models-vascular-plants.R
}
if (!exists("run_03d", inherits = FALSE)) {
  run_03d <- TRUE # 03d_model-validation-vascular-plants.R
}
...
if (run_03d) {
  # 03d reads the models written by 02d. When 02d runs in the same
...
if (run_02d) {
  run_step(
    label = "02d: Hierarchical models (vascular plants)",
    script = "02d_hierarchical-models-vascular-plants.R",
...
if (run_03d) {
  run_step(
    label = "03d: Model validation (vascular plants)",
    script = "03d_model-validation-vascular-plants.R",
    code_dir = v2_code_dir,
    run_dir = v2_root,
    log_dir = log_path,
    protect = runner_objects
