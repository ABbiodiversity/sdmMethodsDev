# ---
# title: "Model Validation (Vascular Plants)"
...
# outputs: ["3_output/tables/vascular-plant-models-validation.Rdata"]
# notes: 
#   "This script performs model validation checks (e.g., AUC, prediction methods, etc) 
#    for the vascular-plant species models."
# ---
...
load("3_output/models/vascular-plant-species-models.Rdata")
...
# 4.0 Save results ----
save(vegetation.fit, soil.fit, file = "3_output/validation/vascular-plant-models-validation.Rdata")
