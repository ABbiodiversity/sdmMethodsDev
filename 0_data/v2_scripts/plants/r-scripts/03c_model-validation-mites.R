...
# outputs: ["3_output/tables/mite-models-validation.Rdata"]
# notes: 
#   "This script performs model validation checks (e.g., AUC, prediction methods, etc) 
#    for the mite species models."
# ---
...
load("3_output/models/mite-species-models.Rdata")
...
# 4.0 Save results ----
save(vegetation.fit, soil.fit, file = "3_output/validation/mite-models-validation.Rdata")
