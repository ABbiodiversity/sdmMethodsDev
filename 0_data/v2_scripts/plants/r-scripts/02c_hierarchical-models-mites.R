# ---
# title: "ABMI Heirachical Models (Mites)"
# author: "Brandon Allen"
# created: "2024-12-16"
# inputs: ["0_data/species/processed/mite-model-data.Rdata";
#          "0_data/bootstrap/mite-bootstrap-ids.Rdata";
#          "1_code/r-scripts/hierarchical-model_functions.R"]
# outputs: ["3_output/models/mite-species-models.Rdata"]
# notes: 
#   "This script generates the bootstrap species distribution models for mites"
# ---
...
load("0_data/bootstrap/mite-bootstrap-ids.Rdata")
...
coef.names <- c("Intercept", "Climate", colnames(veg.data)[328:414])
...
save(climate.coef, soil.coef, vegetation.coef, file = "3_output/models/mite-species-models.Rdata")
